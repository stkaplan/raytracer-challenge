...
TEST_CASE("Lighting with eye between light and surface")
{
    ...
    auto result = m.lighting(Sphere(), light, pos, eye, normal, false);
...
TEST_CASE("Lighting with surface in shadow")
{
    ...
    PointLight light(make_point(0, 0, -10), make_color(1, 1, 1));
    bool in_shadow = true;
    auto result = m.lighting(Sphere(), light, pos, eye, normal, in_shadow);
    REQUIRE(result == make_color(0.1, 0.1, 0.1));
}
...
TEST_CASE("Lighting with a pattern applied")
{
    ...
    PointLight light(make_point(0, 0, -10), make_color(1, 1, 1));
    auto c1 = m.lighting(Sphere(), light, make_point(0.9, 0, 0), eye_vector, normal_vector, false);
    auto c2 = m.lighting(Sphere(), light, make_point(1.1, 0, 0), eye_vector, normal_vector, false);
